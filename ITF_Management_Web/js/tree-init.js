    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource3 = new DataSourceTree({
                data: [
                    { name: 'CA <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: 'MSP <div class="tree-actions"></div>', type: 'folder', additionalParameters: { id: 'F12' } },
            ...
            var treeDataSource4 = new DataSourceTree({
                data: [
                    { name: 'CA<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: 'MSP<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i ></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: 'order<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: 'tlsca<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: 'users<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } }
                ],
                delay: 400
            });
